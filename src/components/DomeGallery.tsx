...
export default function DomeGallery({
  ...
  const cssStyles = `
    ...
    .item__image:hover {
      filter: brightness(1) saturate(1.4) drop-shadow(0 0 20px hsl(180 100% 60% / 0.5));
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      background: 'linear-gradient(135deg, hsl(260 40% 15%), hsl(270 50% 20%))'
                    }}
                  >
                    <img
                      src={it.src}
