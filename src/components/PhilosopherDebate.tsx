            ...
            <div className="flex items-center justify-between">
              ...
              <div className="px-6 flex flex-col items-center gap-2">
                ...
                <Dialog>
                  ...
                  <DialogContent className="bg-[hsl(240,45%,6%)] border-[hsl(270,60%,50%)]/30 text-[hsl(40,20%,95%)] max-w-4xl max-h-[80vh] overflow-y-auto [&>button]:text-[hsl(270,60%,75%)] [&>button]:hover:text-[hsl(270,60%,85%)] [&>button]:hover:bg-transparent [&>button]:focus:ring-0 [&>button]:focus:ring-offset-0 [&>button]:focus:outline-none">
                    <DialogHeader>
